...
//        // Get the new first name from the TextField
...
//
//            // Update the first name in Firestore
//            updateFirstNameInFirestore(uid, updatedFirstName);
//        }
    }
    ...
    private void updateFirstNameInFirestore(String uid, String newFirstName) {
        try {
            DocumentReference userRef = App.db.collection("Users").document(uid);
